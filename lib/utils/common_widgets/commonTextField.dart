...
class CommonTextFormFieldRounded extends StatelessWidget {
  ...
  const CommonTextFormFieldRounded(
      {super.key,
      this.hintText,
      this.controller,
      this.validator,
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      style: commonTextStyle.copyWith(
        fontSize: 12,
        color: enabled ? Constants.blackColour : Constants.greyColour,
      ...
      decoration: InputDecoration(
        hintText: hintText,
        filled: true,
        labelStyle: commonTextStyle.copyWith(
          fontSize: 12,
        ...
        contentPadding: EdgeInsets.symmetric(
            vertical: maxLines! > 1 ? 10 : 0, horizontal: 12.0),
        ...
        disabledBorder: OutlineInputBorder(
          ...
          borderSide: useGrey
              ...
              : BorderSide(color: Constants.greyColour.withAlpha(70)),
        ),
        prefixIcon:
        ...
        suffixIcon: suffixIcon != null
            ? IconButton(
                icon: Icon(suffixIcon, color: Constants.primaryGreenColour),
